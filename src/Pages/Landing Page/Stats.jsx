...
const Stats = () => {
    return (
        <div className="bg-gray-200 py-12 grid grid-cols-1 md:grid-cols-3 gap-6 items-center px-4 lg:px-[130px]">
            ...
            <div className="">
                ...
                <p className="text-xs w-3/5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere quia odio aut architecto</p>
            </div>
            <div className="">
